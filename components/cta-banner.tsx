      ...
      <div className="dark:border relative overflow-hidden my-20 w-full dark bg-background text-foreground max-w-screen-lg mx-auto rounded-2xl py-10 md:py-16 px-6 md:px-14">
        ...
        <div className="relative z-0 flex flex-col gap-3">
          <h3 className="text-3xl md:text-4xl font-semibold">
            Unlock Your Potential with ModerateX
          </h3>
          <p className="mt-2 text-base md:text-lg">
            Boost your Social management efficiency with Web3-powered tools. start exploring!
          </p>
        </div>
        <div className="relative z-0 mt-14 flex flex-col sm:flex-row gap-4">
          ...
          <Link href="https://t.me/moderatexbot" target="_blank" rel="noopener noreferrer">
            <Button size="lg" className="hidden xs:inline-flex">
              Telegram Bot <ArrowUpRight className="!h-5 !w-5" />
            </Button>
          </Link>
          <Button size="lg" variant={"outline"} disabled className="hidden xs:inline-flex">
